...
public class DefaultFECCodeFactory extends FECCodeFactory {
    ...
    public DefaultFECCodeFactory() {
        ...
        try {
            ...
            fecProperties.load(
                DefaultFECCodeFactory.class.getClassLoader().getResourceAsStream(
                    System.getProperty(
        ...
        while (st.hasMoreTokens()) {
            ...
            try {
                Constructor con = Class.forName(getProperty("com.onionnetworks.fec." + key
                                      + ".class")).getConstructor(new Class[] { int.class,
                        int.class });
    ...
    public synchronized FECCode createFECCode(int k, int n) {
        ...
        if (result == null) {
            if ((k < 1) || (k > 65536) || (n < k) || (n > 65536)) {
                throw new IllegalArgumentException("k and n must be between 1 and 65536 and n must not be "
