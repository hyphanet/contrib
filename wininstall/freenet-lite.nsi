...
#
# NOTE - if this script is run by itself, it will automatically generate just Freenet Lite
#      - to generate Freenet Standard, run the script 'freenet-std' instead
#      - the flag 'embedJava', if set, results in Freenet Standard. Default is Freenet Lite
#
# These options added by David McNab, May 2001

!ifdef embedJava
Name "Freenet 0.3.8.1 Standard"
!else
Name "Freenet 0.3.8.1 Lite"
!endif
...
LicenseData GNU.txt
!ifdef embedJava
OutFile Freenet-Std-setup0.3.8.1.exe
!else
OutFile Freenet-Lite-setup0.3.8.1.exe
!endif
...
!ifdef embedJava
ComponentText "This will install Freenet 0.3.8.1 (standard), including Java runtime, on your system."
!else
ComponentText "This will install Freenet 0.3.8.1 (lite), without Java, on your system."
!endif
